...
@JdbcConfig(dataSource = H2DataSourceSupplier.class,
        querySql = "select distinct paramkey,paramvalue from test.setting_info",
        keyColName = "paramkey", valueColName = "paramvalue")
